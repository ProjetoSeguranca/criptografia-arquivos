    ...
    <div id="formCompart">
      ...
      <form method="post" name="formCompartilhar" onsubmit="return sendCompartilhamento(event);">
        <div class="form-group">
          <input type="text" class="form-control" name="loginCompart" id="loginCompart" placeholder="Compartilhar com: ">
        </div>
        <div class="form-group">
  ...
  <div class="container">
    ...
    <div class="arquivos">
      ...
      <div class="formEnviar">
        <input class="btn" type="file" name="file" id="file" accept="image/png, image/jpeg">
        <input class="btn btn-primary" type="button" onclick="sendFile()" value="Enviar arquivo">
      </div>
